...
export default function Gallery() {
  ...
  return (
    <>
      ...
      <section id="our-work" style={{ padding: "80px clamp(24px, 6vw, 100px)", background: "#f2ede6" }}>

        {/* Header */}
        <Reveal>
          <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", flexWrap: "wrap", gap: 20, marginBottom: 52 }}>
            <div>
              <div style={{ fontFamily: "'Jost', sans-serif", fontSize: 10, letterSpacing: "0.28em", color: "#8b7355", textTransform: "uppercase", marginBottom: 14, display: "flex", alignItems: "center", gap: 10 }}>
                <Sparkle size={8} color="#c8b89a" /> Our Work
              </div>
              <h2 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "clamp(32px, 4.5vw, 56px)", fontWeight: 300, lineHeight: 1.1, color: "#1a1410" }}>
                Homes we've<br /><em>enchanted</em>
              </h2>
            </div>
            <p style={{ fontFamily: "'Jost', sans-serif", fontSize: 13, lineHeight: 1.85, color: "#6b5e52", maxWidth: 300, fontWeight: 300 }}>
              ...
              <Reveal key={item.label} delay={i * 70} style={{ gridColumn: cfg.col, gridRow: cfg.row, minHeight: cfg.minH }}>
                ...
                >
                  ...
                  <div className="overlay" style={{ position: "absolute", inset: 0, background: "rgba(15,10,6,0)", transition: "background 0.4s" }}>
                    ...
                    <div className="glabel" style={{ position: "absolute", bottom: 14, left: 16, fontFamily: "'Jost', sans-serif", fontSize: 10, letterSpacing: "0.18em", color: "#f5f0e8", textTransform: "uppercase", opacity: 0, transition: "opacity 0.35s" }}>
                      {item.label}
                    </div>
                  </div>
                </div>
        ...
        <Reveal delay={200}>
          <div style={{ textAlign: "center", marginTop: 36, display: "flex", alignItems: "center", justifyContent: "center", gap: 12 }}>
            ...
            <p style={{ fontFamily: "'Jost', sans-serif", fontSize: 11, letterSpacing: "0.12em", color: "#8b7355" }}>
              Click any image to enlarge · All photos from real East London homes
            </p>
            <Sparkle size={9} color="#c8b89a" />
          </div>
        </Reveal>
