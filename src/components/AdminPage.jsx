...
export default function AdminPage() {
  ...
  const [reportsMode,           setReportsMode]           = useState('taxYear'); // 'taxYear' | 'month'
    ...
    <div style={{ minHeight: '100vh', background: C.bg, fontFamily: FONT, paddingTop: 54 }}>
      ...
      <div style={{ marginLeft: isMobile ? 0 : 240, minHeight: 'calc(100vh - 54px)' }}>
        ...
        {activeView === 'reports' && (() => {
          ...
          // Fixed costs active during a given period (startDate ≤ periodEnd AND endDate ≥ periodStart or no endDate)
          ...
          // ── Month mode: supplies total for the period ──
          const monthSuppliesTotal = isMonthMode ? expenses.filter(e => e.date >= periodStart && e.date <= periodEnd && e.category === 'Supplies').reduce((s, e) => s + (parseFloat(e.amount)||0), 0) : 0;
            ...
            <div>
              ...
              {!isMonthMode ? (
                ...
                <div style={{ marginBottom: 20 }}>
                  ...
                  {/* Month buttons — 12 fixed slots, grey out unavailable */}
              ...
              <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr 1fr' : 'repeat(5,1fr)', gap: 12, marginBottom: 20 }}>
                {[
                  ...
                  { label: isMonthMode ? 'Fixed Costs' : 'Fixed Costs', value: isMonthMode ? `£${fixedMonthly.toFixed(0)}/mo` : `£${fixedMonthly.toFixed(0)}/mo`, sub: isMonthMode ? 'this month' : `£${(fixedMonthly*12).toFixed(0)}/yr`, color: '#f97316' },
              ...
              {/* MoM + Reimbursables row */}
              <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : '1fr 1fr', gap: 16, marginBottom: 16 }}>

                {/* Month-on-month growth (tax year only) OR monthly cost summary */}
                {!isMonthMode ? (
                  <div style={RCARD}>
