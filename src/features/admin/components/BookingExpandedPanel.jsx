  ...
  const handleAddNewVisit = async () => {
    ...
    try {
      const newBooking = {
        ...
        total:           b.mediaConsentDiscount ? parseFloat(b.originalTotal || b.total) + parseFloat(b.mediaConsentDiscount || 0) : (b.total || 0),
        deposit:         0,
        remaining:       b.mediaConsentDiscount ? parseFloat(b.originalTotal || b.total) + parseFloat(b.mediaConsentDiscount || 0) : (b.total || 0),
